...
MODEL_NAME = 'phone_det_graph'  # change to whatever folder has the new graph
...
PATH_TO_LABELS = os.path.join('data', 'phone_labelmap.pbtxt')

NUM_CLASSES = 1  # we are only using one class in this example (cars)
